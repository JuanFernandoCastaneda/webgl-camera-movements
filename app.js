...
function reiniciarAngulo () {
    xAngle.value = 0, angleX = 0;
    yAngle.value = 0, angleY = 0;
    zAngle.value = 0, angleZ = 0;
}

const reiniciarPosiciones = () => {
    xRanger.value = 0, cakeX = 0;
    yRanger.value = 0, cakeY = 0;
    zRanger.value = 0, cakeZ = 0;
}
...
function main() {
    ...
    // mat4.lookAt(mat4.create(), [0, -2, 8], [0, 0, 0], [0, -1, 0])
